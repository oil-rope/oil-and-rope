...
# Defines Manager
# https://docs.djangoproject.com/en/4.1/ref/settings/#managers
...
INSTALLED_APPS = [
    ...
    # The “sites” framework (https://docs.djangoproject.com/en/4.1/ref/contrib/sites/)
...
# https://docs.djangoproject.com/en/4.1/ref/settings/#file-upload-max-memory-size

FILE_UPLOAD_MAX_MEMORY_SIZE = 6291456

# The maximum size in bytes that a request body may be
# https://docs.djangoproject.com/en/4.1/ref/settings/#data-upload-max-memory-size
